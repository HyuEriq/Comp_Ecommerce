                ...
                @foreach ($carts as $key => $items)
                    <div class="grid grid-cols-1 lg:grid-cols-2 min-[550px]:gap-6 border-t border-gray-200 py-6 px-4">
                        <div
                            ...
                            <div class="img-box"><img src="{{ asset('storage/produk/' . $items->produk->foto_produk) }}"
                                    alt="perfume bottle image" class="xl:w-[120px]"></div>
                            <div class="pro-data w-full max-w-sm ">
                                ...
                                <p
                                    ...
                                    {{ $items->produk->Kategori->nama_kategori }}</p>
                            </div>
                        </div>
                        <div
                            ...
                            <h6
                                ...
                                Rp. {{ number_format($items->produk->harga, 0,',','.') }} <span
                                    class="text-sm text-gray-300 ml-3 lg:hidden whitespace-nowrap">Harga</span></h6>
                    ...
                    @push('scripts')
                        <script>
                            ...
                            function formatNumber(num) {
                                return num.toLocaleString('id-ID'); // Menggunakan locale 'id-ID' untuk format Indonesia
                            }
