                    ...
                    <div class="flex gap-3">
                        ...
                        <form action="{{ route('History.index') }}" method="get">
                            ...
                            <div class="flex gap-3 justify-center items-center">
                                <input type="date" name="startDate" id="start_date" value="{{ $startDate ?? '' }}" class="...">
                                <p>to</p>
                                <input type="date" name="endDate" id="end_date" value="{{ $endDate ?? '' }}" class="...">
                                <button type="submit" class="py-2 px-5 bg-gradient-to-tl from-blue-400 to-blue-500 rounded-lg text-sm text-white">Filter</button>
                            <button type="submit" name="export" value="pdf" class="py-2 px-5 bg-gradient-to-tl from-blue-500 to-violet-500 rounded-lg text-sm text-white">Export PDF</button>
                            </div>
                        </form>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td
                                            ...
                                            <p
                                                class="mb-0 text-sm font-semibold leading-normal dark:text-white dark:opacity-60">
                                                Rp {{ number_format($items->total, 0, ',', '.') }}</p>
                                        </td>
                                        <td
                                        class="pt-2 px-6 align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparent">
                                        <p
