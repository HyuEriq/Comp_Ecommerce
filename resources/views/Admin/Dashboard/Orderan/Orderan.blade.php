...
@include('Admin.Dashboard.Orderan.Update')

@include('Admin.Dashboard.Orderan.delete')
            ...
            <div class="flex-auto px-0 pt-0 pb-2">
              <div class="p-0 overflow-x-auto">
                <table class="items-center w-full mb-0 align-top border-collapse dark:border-white/40 text-slate-500">
                  ...
                  @php
                        $counter = ($dataorderan->currentPage() - 1) * $dataorderan->perPage() + 1;
                  @endphp
                ...
                <div class="my-3 mx-4">
                    {{ $dataorderan->links('pagination::simple-tailwind') }}
                  </div>
              </div>
            </div>
          </div>
