<dialog id="my_modal_tambah" class="modal modal-bottom sm:modal-middle">
    <div class="modal-box bg-white">
        <form  action="{{ route('Slider.Store') }}"  method="POST" class="w-full" enctype="multipart/form-data">
        <h3 class="font-bold text-lg">Tambah Data Slider</h3>
                @csrf
                <div class="grid gap-4 mb-4 grid-cols-2">
                    <div class="col-span-2">
                        <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama Slider</label>
                    ...
                    <div class="col-span-2">
                        <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" for="user_avatar">Gambar Slider</label>
