...
@section('content')
    ...
    @include('Admin.Dashboard.Produk.update')

    @include('Admin.Dashboard.Produk.delete')
            ...
            <div
                ...
                <div
                    ...
                    <div class="flex gap-3">
                        ...
                        <button onclick="my_modal_tambah.showModal()" type="submit"
                ...
                <div class="flex-auto px-0 pt-0 pb-2">
                    <div class="p-0 overflow-x-auto">
                        <table
                            ...
                            @php
                                $counter = ($Produk->currentPage() - 1) * $Produk->perPage() + 1;
                            @endphp
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td
                                            ...
                                            <p
                                                class="mb-0 text-sm font-semibold leading-normal dark:text-white dark:opacity-60">
                                                {{ $items->kategori->nama_kategori }}</p>
                                        </td>
                                        <td
                                        ...
                                        <td
                                            class="pt-2 px-6 align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparent">
                                            <button onclick="my_modal_update{{ $key }}.showModal()" type="submit"
                                                class="py-2 px-6 bg-blue-600 rounded-lg  hover:bg-blue-700 text-xs text-white font-semibold leading-tight dark:text-white dark:opacity-80">Edit</button>
                                            <button onclick="my_modal_delete{{ $key }}.showModal()" type="submit"
                                                class=" py-2 px-6 bg-red-600 rounded-lg  hover:bg-red-700 text-xs text-white font-semibold leading-tight dark:text-white dark:opacity-80">Delete</button>
                                            <a href="{{ route('Detail.Produk', $items->id) }}"
                                                class=" py-2 px-6 bg-sky-600 rounded-lg  hover:bg-sky-700 text-xs text-white font-semibold leading-tight dark:text-white dark:opacity-80">
                                                Details</a>
                                        </td>
                                    </tr>
                                </tbody>
                        ...
                        <div class="mt-5 mx-4">
                            {{ $Produk->links('vendor.pagination.simple-tailwind') }}
                        </div>
    ...
    @include('Admin.Dashboard.Produk.Insert')
