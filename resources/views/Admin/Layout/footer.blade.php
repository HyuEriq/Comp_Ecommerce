...
<!-- plugin for charts  -->
<script src="{{ asset('template/build/assets/js/plugins/chartjs.min.js') }}" ></script>
<!-- plugin for scrollbar  -->
<script src="{{ asset('template/build/assets/js/plugins/perfect-scrollbar.min.js') }}" ></script>
<!-- main script file  -->
<script src="{{ asset('template/build/assets/js/argon-dashboard-tailwind.js?v=1.0.1') }}" ></script>

<script src="{{ asset('template/build/assets/js/sidenav-burger.js') }}" ></script>

<script src="{{ asset('template/build/assets/js/dropdown.js') }}" ></script>

<script src="{{ asset('template/build/assets/js/fixed-plugin.js') }}" ></script>

<script src="{{ asset('template/build/assets/js/nav-pills.js') }}" ></script>

<script src="{{ asset('template/build/assets/js/navbar-sticky.js') }}" ></script>

<script src="{{ asset('template/build/assets/js/tooltips.js') }}" ></script>
